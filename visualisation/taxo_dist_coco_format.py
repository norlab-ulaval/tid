...
def plot_taxonomic_distribution(json_file):
    ...
    for annotation in coco_data["annotations"]:
        ...
        species = coco_data["categories"][category]["name"]
    ...
    axs[1, 1].set_xlabel('Species', fontsize=8)
    axs[1, 1].set_ylabel('Count', fontsize=8)
...
# Example usage
anno_dir = "/mnt/e1e899db-64e7-4653-855e-c0cbffc9c675/data/datasets/ville_mtl_102mp/annotations/"
plot_taxonomic_distribution(anno_dir + "annotations_taxo.json")
