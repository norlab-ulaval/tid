...
def create_loader(
    ...
    try:
        ...
        loader = loader_class(dataset, **loader_args)
    if use_prefetcher and not use_full_taxon:
    ...
    elif use_prefetcher and use_full_taxon:
        prefetch_re_prob = re_prob if is_training and not no_aug else 0.
        loader = PrefetchLoaderNeats(
            loader,
            mean=mean,
            std=std,
            channels=input_size[0],
